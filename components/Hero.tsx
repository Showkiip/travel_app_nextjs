    ...
    >
      ...
      <div className="relative z-20 flex flex-1 flex-col xl:w-1/2">
        ...
        <p className="regular-16 mt-6 text-gray-30 xl:max-w-[520px]">
          ...
          consequatur fuga eveniet consectetur nihil, animi culpa quidem et
          dolorem perferendis sunt repellat odio ut aliquam! Possimus nulla
          magni voluptates autem?
        </p>
      ...
      <div className="relative flex flex-1 items-start ">
        <div className="relative z-20  w-[268px] flex flex-col gap-8 rounded-3xl bg-green-90 px-7 py-8 ">
          <div className="flex flex-col">
            ...
            <p className="bold-24 text-white">Aguas Calientes</p>
          </div>
          <div className="flexBetween">
            <div className="flex flex-col">
              <p className="regular-16 block text-gray-20">Distance</p>
              <p className="bold-20 text-white">173.23 m</p>
            </div>
            <div className="flex flex-col">
